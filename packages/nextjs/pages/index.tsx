      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5 flex flex-col justify-center items-center">
          ...
          <p className="text-center text-lg w-1/2">
            ...
            premiaciones con insignias, tokens y NFT’s que podrás reclamar a medida que vayas avanzando en tu formación,
            cumpliendo los desafíos de cada módulo y, sobre todo, participando en las actividades síncronas (on line)
            que tendremos cada semana.
          </p>
          <p className="text-center text-lg w-1/2">
            Hemos distribuido el contenido en cinco (05) módulos, siendo la duración del programa de 10 semanas en las
            que deberás dedicar al menos 5 horas semanales para la revisión del material y el desarrollo de los desafíos
            de cada módulo. En total, dedicarás alrededor de 50 horas de formación.
          </p>
          <p className="text-center text-lg w-1/2">
          ...
          <p className="text-center text-lg w-1/2">
            Te invitamos a comenzar el programa de formación revisando la sección Información General, donde encontrarás
            los materiales del programa: objetivos de aprendizaje, criterios de evaluación, estructura del curso,
            conceptos clave, sistema de recompensa y tutoriales para puedas acceder a los premios.
          </p>
          <p className="text-center text-lg w-1/2">
          ...
          <p className="text-center text-lg w-1/2">¡Comencemos!</p>
        </div>
